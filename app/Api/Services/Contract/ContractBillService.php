...

{
   ...
   * @return   [type]                  [description]
   */
  private function billFree($freeList,$startDate,$endDate,$monthAmount,$dayAmount,$freeType){
...
public function createBillByzhangqi($DA,$billType="rental"){
   ...
   * @return   [type]                 [结束时间]
   */
  private function endDateByDays($startDate,$period,$freeList,$days,$signEndDate,$freeRemark ="")
  {
    if ($period == 0) {
      $endDate = $startDate;
    }else {
