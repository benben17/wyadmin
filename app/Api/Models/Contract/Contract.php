...
class Contract extends Model
{
  ...
  */
  ...
  protected $fillable = ['company_id','proj_id','contract_no','contract_type','violate_rate','contract_state','sign_date','start_date','end_date','belong_uid','belong_person','customer_id','customer_name','customer_industry','customer_sign_person','customer_legal_person','sign_area','c_uid','u_uid','lease_term','audit_uid','audit_state','attr','bank_account_id','rental_deposit_amount','rental_deposit_month','increase_year','increase_rate','increase_date','bill_day','ahead_pay_month','rental_price_type','rental_price','rental_month_amount','management_price','pay_method','rental_bank_name','rental_account_name','rental_account_number','manager_bank_name','manager_account_name','manager_account_number','rental_bank_id','manager_bank_id','manager_deposit_month','manager_deposit_amount','manager_show','increase_show','rental_usage','management_month_amount'];
